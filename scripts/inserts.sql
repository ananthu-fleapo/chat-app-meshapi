...
-- Source rows   : 391
-- After dedup   : 391  (unique model_id + provider)
-- Generated     : 2026-04-28 08:59 UTC
...
-- google/gemini-2.0-flash-001  [opnrouter]
INSERT INTO model_pricing (
    model_id, provider_model_id, model_name, provider,
    modality, input_modalities, output_modalities,
    pricing_unit, currency,
    ...
    'google/gemini-2.0-flash-001', 'gemini-2.0-flash-001', 'Gemini 2.0 flash 001', 'opnrouter',
    ARRAY['text']::modality_enum[], ARRAY['text']::modality_enum[], ARRAY['text']::modality_enum[],
    'per_1k_tokens', 'USD',
    0.0001, 0.0004,
    FALSE, FALSE, TRUE,
...
-- google/gemini-2.5-flash-image  [vertex]
INSERT INTO model_pricing (
    model_id, provider_model_id, model_name, provider,
    modality, input_modalities, output_modalities,
    pricing_unit, currency,
    ...
    'google/gemini-2.5-flash-image', 'gemini-2.5-flash-image', 'Gemini 2.5 flash image', 'vertex',
    ARRAY['text','image']::modality_enum[], ARRAY['text','image']::modality_enum[], ARRAY['text']::modality_enum[],
    'per_1k_tokens', 'USD',
    0.0003, 0.03,
    FALSE, FALSE, TRUE,
...
-- google/gemini-3-flash-preview  [vertex]
INSERT INTO model_pricing (
    model_id, provider_model_id, model_name, provider,
    modality, input_modalities, output_modalities,
    pricing_unit, currency,
    ...
    'google/gemini-3-flash-preview', 'gemini-3-flash-preview', 'Gemini 3 flash preview', 'vertex',
    ARRAY['text']::modality_enum[], ARRAY['text']::modality_enum[], ARRAY['text']::modality_enum[],
    'per_1k_tokens', 'USD',
    0.0005, 0.003,
    FALSE, FALSE, TRUE,
...
-- google/gemini-3.1-flash-image-preview  [vertex]
INSERT INTO model_pricing (
    model_id, provider_model_id, model_name, provider,
    modality, input_modalities, output_modalities,
    pricing_unit, currency,
    ...
    'google/gemini-3.1-flash-image-preview', 'gemini-3.1-flash-image-preview', 'Gemini 3.1 flash image preview', 'vertex',
    ARRAY['text','image']::modality_enum[], ARRAY['text','image']::modality_enum[], ARRAY['text']::modality_enum[],
    'per_1k_tokens', 'USD',
    0.0005, 0.049585,
    FALSE, FALSE, TRUE,
...
-- google/gemini-3.1-flash-lite-preview  [vertex]
INSERT INTO model_pricing (
    model_id, provider_model_id, model_name, provider,
    modality, input_modalities, output_modalities,
    pricing_unit, currency,
    ...
    'google/gemini-3.1-flash-lite-preview', 'gemini-3.1-flash-lite-preview', 'Gemini 3.1 flash lite preview', 'vertex',
    ARRAY['text']::modality_enum[], ARRAY['text']::modality_enum[], ARRAY['text']::modality_enum[],
    'per_1k_tokens', 'USD',
    0.00025, 0.0015,
    FALSE, FALSE, TRUE,
...
INSERT INTO model_pricing (
    ...
    'google/gemini-3.1-pro-preview', 'gemini-3.1-pro-preview', 'Gemini 3.1 pro preview', 'vertex',
    ARRAY['text']::modality_enum[], ARRAY['text']::modality_enum[], ARRAY['text']::modality_enum[],
    'per_1k_tokens', 'USD',
    0.002, 0.012,
    FALSE, FALSE, TRUE,
