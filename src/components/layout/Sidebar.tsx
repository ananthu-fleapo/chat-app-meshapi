...
export function Sidebar() {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col px-3 pt-4 pb-3 border-b border-gray-100 shrink-0 gap-2">
        ...
        <AnimatePresence initial={false}>
          {!collapsed && (
            ...
            >
              <a
                href="/images"
                className="flex items-center gap-2 px-2 py-1.5 text-sm font-medium text-gray-600 hover:bg-purple-50 hover:text-purple-700 rounded-lg transition-colors"
              >
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="shrink-0">
              ...
              <a
                href="/"
                className="flex items-center gap-2 px-2 py-1.5 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-900 rounded-lg transition-colors"
              >
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="shrink-0">
