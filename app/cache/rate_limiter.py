...
async def check_rate_limits(
    ...
    default_rpm  System default from Settings (60).
    default_rpd  System default from Settings (1000).
    """
    effective_rpm = rpm_limit if rpm_limit is not None else default_rpm
    effective_rpd = rpd_limit if rpd_limit is not None else default_rpd
